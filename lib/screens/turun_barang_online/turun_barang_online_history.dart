...
class TurunBarangOnlineHistoryScreen extends StatefulWidget {
  const TurunBarangOnlineHistoryScreen({Key? key}) : super(key: key);
  static String routeName = "/turun-barang-online-history";

  @override
  State<TurunBarangOnlineHistoryScreen> createState() =>
      _TurunBarangOnlineHistoryScreenState();
}

class _TurunBarangOnlineHistoryScreenState
    extends State<TurunBarangOnlineHistoryScreen> {
